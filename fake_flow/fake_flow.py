...
class fake_flow:
    ...
    def prep_embed(self):
        path = '/content/drive/MyDrive/Work_AsifaJunaid/fake_flow/features'
    ...
    def Network(self):
        print(self.train['features'].shape[1], self.train['features'].shape[2])
    ...
    def run_model(self, type_='train'):
        ...
        file = '/content/drive/MyDrive/Work_AsifaJunaid/fake_flow/saved_models/{}_{}.check'.format(self.__class__.__name__, self.model_name)
        # 1, Compile the model
    ...
    def objective_function(self, params):
        ...
        df_summary_table.to_csv('/content/drive/MyDrive/Work_AsifaJunaid/fake_flow/saved_models/results_{}_{}.csv'.format(self.__class__.__name__, self.model_name), header=True, index=False)
